...
public class custom_order {
    ...
    public static void main(String[] args) {
      ...
      System.out.println("Hello friend!"); // print Hello World to console
    ...
    String filingType; // Filling ordered
    ...
    // STEP 4 DISPLAY MENU
      ...
      System.out.println("      MENU        QUANTITY       BASECOST");
      System.out.println("__________________________________________");
      ...
      System.out.println("Toppings (sprinkles, cinamon, cocoa, nuts)");
      System.out.println("__________________________________________");
    ...
    // STEP 5 PROMPT USER TO ORDER
      ...
      System.out.println("Do you want CUPECAKES or a CAKE?");
    ...
    // STEP 8 PROMPT USER TO CHOOSE TOPPINGS
      ...
      System.out.println("Sprinkles, Cinamon, Cocoa, Nuts");
    ...
    // STEP 9 DISPLAY ORDER CONFIRMATION
      ...
      System.out.println("Filling: " + filingType);
